    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
        ...
        <div className="space-y-1">
          ...
          {R.carGross > 0 && <ResultRow label="קצובת נסיעה" value={R.carGross} info={{
            title: 'קצובת נסיעה',
          ...
          {R.carReimbursement > 0 && (
            <ResultRow
              ...
              value={R.carReimbursement}
              subValue="נטו לעובד — גילום מס ע״י המעסיק"
              info={{
                title: 'החזר הוצאות רכב שירות',
                content: 'החזר חודשי עבור שימוש ברכב פרטי לצרכי עבודה (500 ק״מ).\n\nהמעסיק מגלם את המס (גילום ברוטו) — העובד מקבל נטו.\nאינו ממוסה לעובד ואינו חלק מהברוטו.\n\nסכומים חודשיים נטו:\n• רמה א׳: 499 ₪ (קבוע 159 + משתנה 340)\n• רמה ב׳: 578 ₪ (קבוע 238 + משתנה 340)\n• רמה ג׳: 658 ₪ (קבוע 318 + משתנה 340)\n• רמה ד׳: 727 ₪ (קבוע 387 + משתנה 340)'
              }}
            />
          )}
          {R.ashalPay > 0 && (
            <ResultRow
              label='אש"ל — דמי כלכלה יומיים'
              value={R.ashalPay}
              subValue="21.1 ₪/יום עבודה מעל 10 שעות — פטור ממס"
              info={{
                title: 'אש"ל',
                content: 'דמי כלכלה עבור ימי עבודה שנמשכים מעל 10 שעות.\n\nשיעור: 21.1 ₪ ליום.\nפטורים ממס הכנסה וביטוח לאומי.\n\nאינם חלק מהברוטו — מוצגים בשווי הכלכלי בלבד.'
              }}
            />
          )}
          ...
          <div className="border-t border-slate-200 mt-2 pt-2">
            <ResultRow label="ברוטו שכר" value={R.totalGross} highlight info={{
              title: 'ברוטו שכר',
              content: 'סך כל רכיבי השכר: שכר יסוד + שעות נוספות + קצובת נסיעה + כוננויות + פרמיה + מעונות.\n\nלא כולל שווי שימוש ברכב צמוד, החזר הוצאות רכב שירות ואש"ל (מוצגים בנפרד בשווי הכלכלי).'
            }} />
            {R.companyCarImputationNet > 0 && (
