...
export const CONTRACTS = {
  ...
  "568": {
    ...
    studyFundEmployee: 0.025, studyFundEmployer: 0.075,
    grades: [
      {id:"מ-א-0",  label:"משנה/קצוב 43-45 - ותק 0",   salary:37732.74},
      {id:"מ-א-1",  label:"משנה/קצוב 43-45 - ותק 1",   salary:38304.44},
      {id:"מ-א-2",  label:"משנה/קצוב 43-45 - ותק 2+",  salary:38876.16},
      {id:"ב1-0",   label:"בכיר מוביל ב1 - ותק 0",     salary:34302.49},
      {id:"ב1-1",   label:"בכיר מוביל ב1 - ותק 1",     salary:34874.19},
      {id:"ב1-2",   label:"בכיר מוביל ב1 - ותק 2",     salary:35445.90},
      {id:"ב1-3",   label:"בכיר מוביל ב1 - ותק 3",     salary:36017.62},
      {id:"ב1-4",   label:"בכיר מוביל ב1 - ותק 4",     salary:36589.32},
      {id:"ב1-5",   label:"בכיר מוביל ב1 - ותק 5",     salary:37161.03},
      {id:"ב1-6+",  label:"בכיר מוביל ב1 - ותק 6+",    salary:37732.74},
      {id:"ב2-0",   label:"בכיר מוביל ב2 - ותק 0",     salary:32015.65},
      {id:"ב2-1",   label:"בכיר מוביל ב2 - ותק 1",     salary:32587.36},
      {id:"ב2-2",   label:"בכיר מוביל ב2 - ותק 2",     salary:33159.07},
      {id:"ב2-3",   label:"בכיר מוביל ב2 - ותק 3",     salary:33730.78},
      {id:"ב2-4",   label:"בכיר מוביל ב2 - ותק 4",     salary:34302.49},
      {id:"ב2-5",   label:"בכיר מוביל ב2 - ותק 5",     salary:34874.19},
      {id:"ב2-6+",  label:"בכיר מוביל ב2 - ותק 6+",    salary:35445.90},
      {id:"ב3-0",   label:"בכיר מוביל ב3 - ותק 0",     salary:29728.81},
      {id:"ב3-1",   label:"בכיר מוביל ב3 - ותק 1",     salary:30300.53},
      {id:"ב3-2",   label:"בכיר מוביל ב3 - ותק 2",     salary:30872.24},
      {id:"ב3-3",   label:"בכיר מוביל ב3 - ותק 3",     salary:31443.94},
      {id:"ב3-4",   label:"בכיר מוביל ב3 - ותק 4",     salary:32015.65},
      {id:"ב3-5",   label:"בכיר מוביל ב3 - ותק 5",     salary:32587.36},
      {id:"ב3-6+",  label:"בכיר מוביל ב3 - ותק 6+",    salary:33159.07},
    ]
  },
  "569": {
    ...
    studyFundEmployee: 0.025, studyFundEmployer: 0.075,
    grades: [
      {id:"ג1-0",  label:"בכיר שאינו מוביל ג1 - ותק 0",  salary:29728.81},
      {id:"ג1-1",  label:"בכיר שאינו מוביל ג1 - ותק 1",  salary:30300.53},
      {id:"ג1-2",  label:"בכיר שאינו מוביל ג1 - ותק 2",  salary:30872.24},
      {id:"ג1-3",  label:"בכיר שאינו מוביל ג1 - ותק 3",  salary:31443.94},
      {id:"ג1-4",  label:"בכיר שאינו מוביל ג1 - ותק 4",  salary:32015.65},
      {id:"ג1-5",  label:"בכיר שאינו מוביל ג1 - ותק 5",  salary:32587.36},
      {id:"ג1-6+", label:"בכיר שאינו מוביל ג1 - ותק 6+", salary:33159.07},
      {id:"ג2-0",  label:"בכיר שאינו מוביל ג2 - ותק 0",  salary:25155.16},
      {id:"ג2-1",  label:"בכיר שאינו מוביל ג2 - ותק 1",  salary:25726.87},
      {id:"ג2-2",  label:"בכיר שאינו מוביל ג2 - ותק 2",  salary:26298.57},
      {id:"ג2-3",  label:"בכיר שאינו מוביל ג2 - ותק 3",  salary:26870.28},
      {id:"ג2-4",  label:"בכיר שאינו מוביל ג2 - ותק 4",  salary:27442.00},
      {id:"ג2-5",  label:"בכיר שאינו מוביל ג2 - ותק 5",  salary:28013.70},
      {id:"ג2-6",  label:"בכיר שאינו מוביל ג2 - ותק 6",  salary:28585.41},
      {id:"ג2-7",  label:"בכיר שאינו מוביל ג2 - ותק 7",  salary:29157.12},
      {id:"ג2-8+", label:"בכיר שאינו מוביל ג2 - ותק 8+", salary:29728.81},
    ]
  },
  "287": {
    name: "צוערים",
  ...
  "557": {
    ...
    studyFundEmployee: 0.025, studyFundEmployer: 0.075,
    grades: [
      {id:"340", label:"רמה 340",        salary:32935.86},
      {id:"350", label:"רמה 350",        salary:34992.64},
      {id:"360", label:"רמה 360",        salary:37051.70},
      {id:"370", label:"רמה 370",        salary:41788.22},
      {id:"450", label:"רמה 450 (מנהל מינהל האדמה)", salary:48354.89},
    ]
  },
  ...
  "402": {
    ...
    grades: [
      ...
      {id:"36א",  label:"דרגה 36א", salary:8995.88},
      {id:"37",   label:"דרגה 37",  salary:9095.59},
      {id:"37א",  label:"דרגה 37א", salary:9608.81},
      {id:"38",   label:"דרגה 38",  salary:10079.41},
      {id:"38א",  label:"דרגה 38א", salary:10592.63},
      {id:"39",   label:"דרגה 39",  salary:10912.67},
      {id:"39א",  label:"דרגה 39א", salary:11425.89},
      {id:"40",   label:"דרגה 40",  salary:12606.59},
      {id:"40א",  label:"דרגה 40א", salary:13119.81},
      {id:"41",   label:"דרגה 41",  salary:14600.60},
      {id:"41א",  label:"דרגה 41א", salary:15113.82},
      {id:"42",   label:"דרגה 42",  salary:16094.00},
      {id:"42א",  label:"דרגה 42א", salary:16607.22},
      {id:"43",   label:"דרגה 43",  salary:17750.30},
      {id:"43א",  label:"דרגה 43א", salary:18263.52},
      {id:"44",   label:"דרגה 44",  salary:19951.08},
      {id:"44א",  label:"דרגה 44א", salary:20464.30},
    ]
  },
  ...
  "568": { name:"סגל בכיר מוביל (568)", shortName:"בכיר מוביל 568", number:"568",
    ...
    pensionEmployee:0.07,pensionEmployer:0.135,studyFundEmployee:0.025,studyFundEmployer:0.075,
    grades:[
      {id:"top0",label:"מינויים מיוחדים - 0 שנים",salary:38849.62},{id:"top1",label:"מינויים מיוחדים - 1 שנה",salary:39438.26},{id:"top2",label:"מינויים מיוחדים - 2+ שנים",salary:40026.89},
      {id:"b1-0",label:"בכיר מוביל ב1 - 0 שנים",salary:35317.84},{id:"b1-1",label:"בכיר מוביל ב1 - 1 שנה",salary:35906.46},
      {id:"b1-2",label:"בכיר מוביל ב1 - 2 שנים",salary:36495.09},{id:"b1-3",label:"בכיר מוביל ב1 - 3 שנים",salary:37083.74},
      {id:"b1-4",label:"בכיר מוביל ב1 - 4 שנים",salary:37672.36},{id:"b1-5",label:"בכיר מוביל ב1 - 5 שנים",salary:38260.99},
      {id:"b1-6",label:"בכיר מוביל ב1 - 6+ שנים",salary:38849.62},
      {id:"b2-0",label:"בכיר מוביל ב2 - 0 שנים",salary:32963.32},{id:"b2-1",label:"בכיר מוביל ב2 - 1 שנה",salary:33551.94},
      {id:"b2-2",label:"בכיר מוביל ב2 - 2 שנים",salary:34140.59},{id:"b2-3",label:"בכיר מוביל ב2 - 3 שנים",salary:34729.22},
      {id:"b2-4",label:"בכיר מוביל ב2 - 4 שנים",salary:35317.84},{id:"b2-5",label:"בכיר מוביל ב2 - 5 שנים",salary:35906.46},
      {id:"b2-6",label:"בכיר מוביל ב2 - 6+ שנים",salary:36495.09},
      {id:"b3-0",label:"בכיר מוביל ב3 - 0 שנים",salary:30608.79},{id:"b3-1",label:"בכיר מוביל ב3 - 1 שנה",salary:31197.42},
      {id:"b3-2",label:"בכיר מוביל ב3 - 2 שנים",salary:31786.05},{id:"b3-3",label:"בכיר מוביל ב3 - 3 שנים",salary:32374.69},
      {id:"b3-4",label:"בכיר מוביל ב3 - 4 שנים",salary:32963.32},{id:"b3-5",label:"בכיר מוביל ב3 - 5 שנים",salary:33551.94},
      {id:"b3-6",label:"בכיר מוביל ב3 - 6+ שנים",salary:34140.59},
    ]},
  ...
  "569": { name:"סגל בכיר שאינו מוביל (569)", shortName:"בכיר לא מוביל 569", number:"569",
    ...
    pensionEmployee:0.07,pensionEmployer:0.135,studyFundEmployee:0.025,studyFundEmployer:0.075,
    grades:[
      {id:"g1-0",label:"בכיר ג1 - 0 שנים",salary:30608.79},{id:"g1-1",label:"בכיר ג1 - 1 שנה",salary:31197.42},
      {id:"g1-2",label:"בכיר ג1 - 2 שנים",salary:31786.05},{id:"g1-3",label:"בכיר ג1 - 3 שנים",salary:32374.69},
      {id:"g1-4",label:"בכיר ג1 - 4 שנים",salary:32963.32},{id:"g1-5",label:"בכיר ג1 - 5 שנים",salary:33551.94},
      {id:"g1-6",label:"בכיר ג1 - 6+ שנים",salary:34140.59},
      {id:"g2-0",label:"בכיר ג2 - 0 שנים",salary:25899.76},{id:"g2-1",label:"בכיר ג2 - 1 שנה",salary:26488.39},
      {id:"g2-2",label:"בכיר ג2 - 2 שנים",salary:27077.02},{id:"g2-3",label:"בכיר ג2 - 3 שנים",salary:27665.64},
      {id:"g2-4",label:"בכיר ג2 - 4 שנים",salary:28254.28},{id:"g2-5",label:"בכיר ג2 - 5 שנים",salary:28842.91},
      {id:"g2-6",label:"בכיר ג2 - 6 שנים",salary:29431.53},{id:"g2-7",label:"בכיר ג2 - 7 שנים",salary:30020.17},
      {id:"g2-8",label:"בכיר ג2 - 8+ שנים",salary:30608.79},
    ]},
  ...
  "557": { name:"בכירים ותיקים - צמודי יוקר (557)", shortName:"בכירים ותיקים 557", number:"557",
    ...
    pensionEmployee:0.07,pensionEmployer:0.135,studyFundEmployee:0.025,studyFundEmployer:0.075,
    grades:[
      {id:"340",label:"רמה 340",salary:33910.75},{id:"350",label:"רמה 350",salary:36028.42},
      {id:"360",label:"רמה 360",salary:38148.43},{id:"370",label:"רמה 370",salary:43025.14},
      {id:"450",label:"רמה 450 (מנהל מינהל האדמה)",salary:49786.19},
    ]},
